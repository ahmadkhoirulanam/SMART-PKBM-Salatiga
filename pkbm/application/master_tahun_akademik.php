                ...
                <div class="box-body">
                  ...
                  <?php 
                    if ($_SESSION[level]=="guru"){
                      $tampil = mysqli_query($koneksi,"SELECT * FROM tahun_akademik WHERE id_pkbm = '$_SESSION[id]' ORDER BY id_tahun_akademik DESC");
                    }else{
...
<?php 
    ...
    if (isset($_POST[tambah])){
        mysqli_query($koneksi,"INSERT INTO tahun_akademik VALUES('$_POST[a]','$idtest','$_POST[b]','$_POST[c]','$_POST[d]')");
        echo "<script>document.location='index.php?view=tahunakademik';</script>";
    }
