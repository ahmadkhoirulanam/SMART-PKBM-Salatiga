            ...
            <div class="col-xs-12">  
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data Warga Belajar</h3>
                  <a class='pull-right btn btn-primary btn-sm' href='index.php?view=tambahwargabelajar'>Tambahkan Data Warga Belajar</a>
                </div>
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                  <?php 
                    $tampil = mysqli_query($koneksi,"SELECT * FROM siswa WHERE pkbm = $_SESSION[id] ORDER BY id_siswa DESC");
                    $no = 1;
                    ...
                    echo "<tr><td>$no</td>
                              ...
                              <td>$r[id_siswa]</td>
                              <td><center>
                                <a class='btn btn-success btn-xs' title='Edit Data' href='?view=editwargabelajar&id=$r[id_siswa]'><span class='glyphicon glyphicon-pencil'></span></a>
