    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <section class="content-header">
          <h1> Daftar PKBM <small>Salatiga</small> </h1>
        </section>
        ...
        <?php
          ...
          while ($r = mysqli_fetch_array($tampil)) { ?>
            <a style='color:#000' href='index.php?view=identitas_pkbm&id=<?php echo $r[nip]?>'>
            <div class="col-md-4 col-sm-6 col-xs-12">
              <div class="info-box">
                <span class="info-box-icon bg-green"><?php echo $no ?></span>
                <div class="info-box-content">
                  <?php $siswa = mysqli_fetch_array(mysqli_query($koneksi, "SELECT count(*) as total FROM siswa where pkbm='$r[nip]'")); ?>
                  <span class="info-box-text"><strong><?php echo $r[nama_guru] ?></strong></span>
                  <span class="info-box-text">Warga Belajar : <?php echo $siswa[total]; ?></span>
