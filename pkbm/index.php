    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <?php 
          ...
          }elseif ($_GET[view]=='warga_belajar'){
              echo "<div class='row'>";
                      include "application/master_warga_belajar.php";
              echo "</div>";

          }elseif ($_GET[view]=='wargabelajarpkbm'){
            echo "<div class='row'>";
                    include "application/master_siswa_admin.php";
            echo "</div>";

          }elseif ($_GET[view]=='rapor'){
            echo "<div class='row'>";
                    include "application/master_rapor.php";
            echo "</div>";

          }
          elseif ($_GET[view]=='ijazah'){
            echo "<div class='row'>";
                    include "application/master_ijazah.php";
            echo "</div>";
          }
          elseif ($_GET[view]=='siswa_paket'){
            echo "<div class='row'>";
                    include "application/master_siswa_kejar.php";
            echo "</div>";
          }
          elseif ($_GET[view]=='addijazah'){
            echo "<div class='row'>";
                    include "application/tambahijazahpkbm.php";
            echo "</div>";
          }
          elseif ($_GET[view]=='addrapor'){
            echo "<div class='row'>";
                    include "application/tambahraporpkbm.php";
            echo "</div>";
          }

          elseif ($_GET[view]=='paket'){
            echo "<div class='row'>";
                    include "application/kejarpaket.php";
            echo "</div>";
          }
          elseif ($_GET[view]=='editwargabelajar'){
            echo "<div class='row'>";
                    include "application/editsiswapkbm.php";
            echo "</div>";
          }
          elseif ($_GET[view]=='tambahwargabelajar'){
            echo "<div class='row'>";
                    include "application/tambahsiswapkbm.php";
            echo "</div>";
          }
          elseif ($_GET[view]=='siswa_pkbm'){
            echo "<div class='row'>";
                    include "application/master_siswa.php";
            echo "</div>";

          }
          elseif ($_GET[view]=='identitas_pkbm'){
            echo "<div class='row'>";
                    include "application/identitas_pkbm.php";
            echo "</div>";

          }
          elseif ($_GET[view]=='tambahsiswaexcel'){
            echo "<div class='row'>";
                    include "application/excel.php";
            echo "</div>";

          }
          elseif ($_GET[view]=='daftarpkbm'){
            echo "<div class='row'>";
                    include "pkbm.php";
            echo "</div>";

          }
          elseif ($_GET[view]=='data_pkbm'){
            cek_session_guru();
            echo "<div class='row'>";
